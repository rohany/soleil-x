-- Runs dom_specified.rg standalone.
...
local DOM = (require 'dom_specified-desugared')(MAX_ANGLES_PER_QUAD, Point_columns, SCHEMA)
...
regentlib.saveobj(main, 'dom_specified_host.o', 'object')
