...
local C = regentlib.c
local MAPPER = terralib.includec("soleil_mapper_specified.h")
...
local DOM = (require 'dom_specified-desugared')(MAX_ANGLES_PER_QUAD, Radiation_columns, SCHEMA)
...
regentlib.saveobj(main, "soleil_specified.o", "object", MAPPER.register_mappers)
