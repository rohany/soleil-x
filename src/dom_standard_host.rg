-- Runs dom_standard.rg standalone.
...
local DOM = (require 'dom_standard-desugared')(MAX_ANGLES_PER_QUAD, Point_columns, SCHEMA)
...
regentlib.saveobj(main, 'dom_standard_host.o', 'object')
